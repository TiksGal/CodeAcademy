...
class Table:
    def __init__(self, table_type: str, table_number: int) -> None:
...
class Reservation:
    def __init__(self, name: str, table_type: str, reservation_time: str) -> None:
        self.name = name
        self.table_type = table_type
        self.reservation_time = reservation_time

# values shows how many tables all types we have
table_types = {
    "Single": 10,
    "Double": 6,
    "Family": 4,
...
def get_reservations() -> List[Reservation]:
    ...
    while True:
        ...
        if reserved == "yes":
            ...
            print(f"Reservation confirmed for {reservation.name} at {reservation.reservation_time} for table type {reservation.table_type}")
